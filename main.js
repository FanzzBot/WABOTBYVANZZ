...
const starts = async (marubotz = new WAConnection()) => {
    ...
    console.log(color(figlet.textSync('TROLI', {
		font: 'Standard',
...
console.log(color('  Bot Wangsaff','mediumseagreen'))
    ...
    console.log(color('[DEV]', 'cyan'), color('Welcome Ro My boy', 'magenta'))
    ...
    marubotz.sendMessage(`62858157008614@s.whatsapp.net`, `halo aku datang aowkwowk`, MessageType.extendedText)
...
marubotz.on("group-participants-update", async (anu) => {
    ...
    try {
      ...
      peh = await getBuffer(`https://api.dhamzxploit.my.id/api/canvas/welcome?pp=https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png?q=60&name=Zets&bg=https://i.pinimg.com/originals/1f/1d/54/1f1d544c61751dee03ab8c33b4bf97e8.jpg&grupname=Moon%20Bot%27s&member=213`)
      marubotz.sendMessage(anu.jid, { contentText: `${teks}`, footerText: `Welcome messages`, buttons: [{ buttonId: `Welcome👋🏻`, buttonText: { displayText: 'Welcome👋🏻' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: peh, contextInfo: {mentionedJid: [num]}}}, 'buttonsMessage')}      
      ...
      pei = await getBuffer(`https://api.dhamzxploit.my.id/api/canvas/goodbye?pp=https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png?q=60&name=Zets&bg=https://i.pinimg.com/originals/1f/1d/54/1f1d544c61751dee03ab8c33b4bf97e8.jpg&grupname=Moon&member=201`)      
      marubotz.sendMessage(anu.jid, { contentText: `${out}`, footerText: `Leaving messages`, buttons: [{ buttonId: `dada beban`, buttonText: { displayText: 'Byee👋🏻' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: pei, contextInfo: {mentionedJid: [num]}}}, 'buttonsMessage')
      }
    } catch (e) {
